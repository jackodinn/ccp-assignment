...
string BattleField::norobot() const
{
    return "No robot exist at such position.\n";
}
...
void BattleField::autoset(int x, int y)
{
    auto temp = obj[y][x];
    int newx;
    int newy;
    ...
    set(temp, newx, newy);
    cout << obj[newx][newy]->getname() << "has respawned at random position." << endl;
}
